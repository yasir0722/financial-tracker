                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="posted_date" id="posted_date" 
                                           ...
                                           value="{{ old('posted_date', $transaction->posted_date->format('Y-m-d')) }}" required>
                                    @error('posted_date')
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="transaction_detail" id="transaction_detail" 
                                           ...
                                           value="{{ old('transaction_detail', $transaction->transaction_detail) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="spending_type_id" id="spending_type_id" 
                                        ...
                                        @foreach($spendingTypes as $id => $name)
                                            <option value="{{ $id }}" 
                                                {{ (old('spending_type_id', $transaction->spending_type_id) == $id) ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="debit" id="debit" 
                                               ...
                                               value="{{ old('debit', $transaction->debit > 0 ? $transaction->debit : '') }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="credit" id="credit" 
                                               ...
                                               value="{{ old('credit', $transaction->credit > 0 ? $transaction->credit : '') }}" 
                                               step="0.01" min="0" placeholder="0.00">
                                        @error('credit')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
